...
namespace Assets.Scripts.Utils.AStar
{
    ...
    public sealed class PathUtil
    {
        ...
        public static LinkedList<Point> Find<TG>(int x1, int y1, int x2, int y2, TG[,] blocks)
            where TG : IGridCell
        {
        ...
        /// <returns>Return the shortest path from start point to end point.otherwise return empty list.</returns>
        public static LinkedList<Point> Find<TG>(int x1, int y1, int x2, int y2, TG[,] blocks, bool allowDiagonals)
            where TG : IGridCell
        {
            if (blocks == null)
        ...
        /// </example>
        private static LinkedList<Point> Find<TG>(Node sNode, Node eNode, TG[,] blocks, bool allowDiagonals)
            where TG : IGridCell
        {
         ...
         */
        private static List<Node> Rounds<TG>(Node center, TG[,] blocks, bool allowDiagonals)
        where TG : IGridCell
        {
         ...
         */
        private static bool IsOutOfBounds<TG>(int x, int y, TG[,] blocks)
            where TG : IGridCell
        {
